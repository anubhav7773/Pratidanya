                        ...
                        children: [
                          Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                const Icon(Icons.policy, size: 12, color: Color(0xFF44474D)),
                                const SizedBox(width: 4),
                                Text(
                                  isEn ? 'DPDP Act 2023 | Sec 5 & 6' : 'DPDP अधिनियम 2023 | धारा 5 एवं 6',
                                  style: const TextStyle(fontSize: 10.5, fontWeight: FontWeight.w600, color: Color(0xFF44474D)),
                                ),
                              ],
                            ),
                          ),
                          ...
                          Text(
                            isEn ? 'Legal Notice & Consent' : 'विधिक सूचना एवं सहमति',
                            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF131B2E)),
                          ),
                        ],
                      ),
                    ],
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const Icon(Icons.shield_outlined, color: Color(0xFF1F6C3A), size: 24),
                          const SizedBox(width: 10),
                          Expanded(
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text(
                                  isEn
                                      ? 'Advocate & Client Privilege Protection'
                                ...
                                Text(
                                  isEn
                                      ? 'This platform guarantees statutory confidentiality under Section 126 of the Indian Evidence Act / Section 132 Bharatiya Sakshya Adhiniyam 2023 and DPDP Act 2023 requirements.'
                                  ...
                                  style: const TextStyle(fontSize: 11.5, color: Color(0xFF44474D), height: 1.4),
                                ),
                              ],
                            ),
                          ),
                    ...
                    _buildClauseCard(
                      number: '01',
                      title: isEn ? 'Clause 1: Purpose of Data Processing' : 'खंड 1: डेटा संग्रहण का उद्देश्य',
                      badgeText: 'Sec 5(1)',
                      badgeBg: const Color(0xFFEAEDFF),
                      badgeFg: const Color(0xFF44474D),
                      bodyText: isEn
                          ? 'Limited processing of advocate and litigant data strictly necessary for case filing, e-Courts cause list matching, legal research, and criminal appeal drafting. Data usage is strictly restricted to judicial proceedings.'
                      ...
                      bottomWidget: Row(
                        children: [
                          _buildChip(icon: Icons.gavel, text: isEn ? 'e-Courts Sync' : 'ई-कोर्ट्स समन्वयन'),
                          const SizedBox(width: 8),
                          _buildChip(icon: Icons.history_edu, text: isEn ? 'Auto Cause List Sync' : 'वाद सूची ऑटो-सिंक'),
                        ],
                      ),
                    ),
                    const SizedBox(height: 12),
                    ...
                    _buildClauseCard(
                      number: '02',
                      title: isEn ? 'Clause 2: Domestic Cloud Data Sovereignty' : 'खंड 2: स्थानीय क्लाउड डेटा संप्रभुता',
                      badgeText: 'AES-256',
                      badgeBg: const Color(0xFFA4F1B2),
                      badgeFg: const Color(0xFF1F6C3A),
                      badgeIcon: Icons.lock,
                      bodyText: isEn
                          ? 'All case records and digital evidence are sovereignly secured within Indian territory at AWS Mumbai (ap-south-1) Tier-4 data centers with 256-bit AES encryption. Cross-border data transfer is strictly prohibited.'
                      ...
                      bottomWidget: Container(
                        ...
                        child: Row(
                          children: [
                            const Icon(Icons.pin_drop, size: 16, color: Color(0xFF1F6C3A)),
                            const SizedBox(width: 6),
                            Expanded(
                              child: Text(
                                isEn
                                    ? 'Data Location: Mumbai, India Sovereign Cluster (AWS ap-south-1)'
                                    : 'डेटा स्थान: मुंबई, भारत संप्रभु क्लस्टर (AWS ap-south-1)',
                                style: const TextStyle(fontSize: 11.5, fontWeight: FontWeight.w500, color: Color(0xFF131B2E)),
                              ),
                            ),
                          ],
                        ),
                    ...
                    _buildClauseCard(
                      number: '03',
                      title: isEn ? 'Clause 3: Right to Correction & Erasure' : 'खंड 3: डेटा विलोपन एवं सुधार का अधिकार',
                      badgeText: 'Sec 8(7)',
                      badgeBg: const Color(0xFFEAEDFF),
                      badgeFg: const Color(0xFF44474D),
                      bodyText: isEn
                          ? 'Under Section 8(7) of the DPDP Act 2023, the advocate possesses the complete statutory right to access, rectify, or completely delete (Right to Erasure / Right to be Forgotten) profile and case data upon case disposal.'
                    ...
                    _buildClauseCard(
                      number: '04',
                      title: isEn ? 'Clause 4: Data Protection Grievance Redressal' : 'खंड 4: डेटा संरक्षण बोर्ड (DPB) शिकायत निवारण',
                      badgeText: 'DPO Cell',
                      badgeBg: const Color(0xFFEAEDFF),
                      badgeFg: const Color(0xFF44474D),
                      bodyText: isEn
                          ? 'For any data protection grievance or query, reach out to the statutory Data Protection Officer (DPO) at dpo@pratidanya.gov.in. Resolution within 48 hours or statutory escalation to the Data Protection Board of India (DPBI).'
                      ...
                      bottomWidget: Row(
                        children: [
                          const Icon(Icons.timer, size: 15, color: Color(0xFF1F6C3A)),
                          const SizedBox(width: 6),
                          Text(
                            isEn
                                ? 'Redressal Timeline: Statutory notice within 48 hours'
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  ...
                                  Expanded(
                                    child: Padding(
                                      ...
                                      child: Text(
                                        isEn
                                            ? 'I have read the statutory notice and hereby grant affirmative consent for judicial case data processing under Sections 5 & 6.'
                            ...
                            SizedBox(
                              ...
                              child: ElevatedButton.icon(
                                ...
                                label: authState.isLoading
                                    ...
                                    : Text(
                                        isEn ? 'Accept Consent & Proceed' : 'सहमति स्वीकार करें एवं आगे बढ़ें',
                            ...
                            TextButton(
                              ...
                              child: Text(
                                isEn ? 'Decline (Exit)' : 'अस्वीकार करें (Exit / Decline)',
                                style: const TextStyle(color: StitchColors.alertCrimson, fontSize: 13, fontWeight: FontWeight.w600),
                              ),
                            ),
                            ...
                            Center(
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                    isEn
                                        ? 'Statutory Certification ID: DPDP-DEL-2024-ADV-891'
