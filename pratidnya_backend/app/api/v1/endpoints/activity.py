...
async def log_activity(
    ...
    current_user: Optional[dict] = Security(verify_advocate_token)
):
    advocate_uid = current_user.get("uid") if current_user else (payload.advocate_id or "ANONYMOUS")
    advocate_email = current_user.get("email") if current_user else "N/A"
